...
// src/pages/admin/Alumni_Management.jsx
// Main page: table, search, filter, sort, seed on first load, uses AlumniForm and AlumniDetails.
                ...
                <tr key={a.id}>
                  ...
                  <td>
                    <div style={{display:'flex', alignItems:'center', gap:8}}>
                      ...
                      {/* Reveal handled in details modal */}
                    </div>
                  </td>
...
// src/pages/admin/Alumni_Management.jsx
// import React, { useEffect, useState } from "react";
// import { FaPlus, FaEdit, FaEye, FaTrash, FaSortAlphaDown, FaSortNumericDown, FaSync } from "react-icons/fa";
...
//   updateAlumnus,
//   deleteAlumnus,
//   forceReseed // <-- new utility for reseeding
// } from "../../utils/storage";
...
//         if (sortBy === "name") return String(x.name || "").localeCompare(y.name || "");
//         if (sortBy === "year")
//           return Number(x.graduationYear || 0) - Number(y.graduationYear || 0);
//         return 0;
//       });
//     }
//     setFiltered(list);
...
//   // NEW: Force reseed handler
//   function handleReseed() {
//     if (!window.confirm("Are you sure you want to reseed the alumni data? This will overwrite everything!")) return;
//     forceReseed();
//     refreshFromStorage();
//   }
...
//           <button className="btn btn-outline-secondary" onClick={() => setSortBy("name")}>
//             <FaSortAlphaDown /> Sort Name
//           </button>
//           <button className="btn btn-outline-secondary" onClick={() => setSortBy("year")}>
//             <FaSortNumericDown /> Sort Year
//           </button>
//           <button className="btn btn-warning" onClick={handleReseed}>
//             <FaSync /> Seed Again
//           </button>
...
//             placeholder="Search by name, email, company or userId"
//             value={searchQ}
...
//                     <td className="text-center">
//                       <div className="d-flex justify-content-center gap-2">
//                         <button className="btn btn-sm btn-info" onClick={() => openDetails(a)}>
//                           <FaEye /> View
//                         </button>
//                         <button className="btn btn-sm btn-warning" onClick={() => openEdit(a)}>
//                           <FaEdit /> Edit
//                         </button>
