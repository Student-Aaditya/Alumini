// // src/components/admin/AlumniForm.jsx
// // Add / Edit form component (modal). 
// // Props:
// //  - show (bool), onClose(), onSave(alumnusObject), initialData (object or null)
// // Uses fileToHash from utils/hash for hashing certificates and password.
...
//   useEffect(() => {
//     if (initialData) {
//       // we keep password blank for edit (admin can set new password)
//       setForm({
//         ...initialData,
//         passwordPlain: "", // transient - if filled, we'll hash and update passwordHash
...
//     // For each file: compute hash + toDataURL
...
//           <h5 style={{margin:0}}>{form.id ? "Edit Alumni" : "Add New Alumni"}</h5>
//           <div>
...
//             <input className="form-control" value={(form.skills||[]).join(", ")} onChange={e=>handleChange("skills", e.target.value)} />
//           </div>
...
//           <div className="col-md-6">
//             <label className="form-label">Password (admin assigns) — leave blank to keep existing</label>
...
//             <label className="form-label">Certificates (PDF or images) — you can upload multiple</label>
...
//                           {c.type && c.type.startsWith("image/") ? <img src={c.dataUrl} alt={c.title} style={{width:'100%',height:'100%',objectFit:'cover'}}/> : <div style={{fontSize:14}}>{c.fileName}</div>}
//                         </div>
//                         <div style={{flex:1}}>
...
//                             <input type="date" className="form-control form-control-sm" style={{width:150}} value={c.issueDate} onChange={e=>updateCertField(c.id,"issueDate",e.target.value)} />
//                           </div>
//                           <div style={{fontSize:12, marginTop:6}}>
//                             Hash: <code style={{wordBreak:'break-all'}}>{c.hash}</code>
//                           </div>
//                         </div>
//                         <div>
...
// };
// const modalStyle = {
//   width: 920, maxWidth: "96%", maxHeight: "90vh", overflowY: "auto", background: "white", padding: 18, borderRadius: 10, boxShadow: "0 8px 30px rgba(0,0,0,0.25)"
// };
