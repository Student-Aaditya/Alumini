...
//   const [interestsInput, setInterestsInput] = useState(""); // controlled string input
...
//             <input className="form-control" value={interestsInput} onChange={e=>setInterestsInput(e.target.value)} />
//           </div>
//           <div className="col-md-3">
